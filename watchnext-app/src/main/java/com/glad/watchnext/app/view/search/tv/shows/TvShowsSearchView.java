package com.glad.watchnext.app.view.search.tv.shows;
 ...
 */
public final class TvShowsSearchView extends FrameLayout implements TvShowsSearchContract.View {
    @NonNull private static final String TAG = LogUtil.getTag(TvShowsSearchView.class);

    @Inject TvShowsSearchContract.Presenter presenter;
    ...
    //region Constructor
    public TvShowsSearchView(@NonNull final Context context) {
        this(context, null);
    }

    public TvShowsSearchView(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TvShowsSearchView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public TvShowsSearchView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
