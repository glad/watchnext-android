 ...
 */
public final class CastCreditsView extends FrameLayout implements CastCreditsContract.View {
    @NonNull private static final String TAG = LogUtil.getTag(CastCreditsView.class);

    @Inject CastCreditsContract.Presenter presenter;
    ...
    //region Constructor
    public CastCreditsView(@NonNull final Context context) {
        this(context, null);
    }

    public CastCreditsView(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CastCreditsView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public CastCreditsView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        Injector.INSTANCE.inject(this);
        inflate(context, R.layout.layout_view_cast_credits, this);
    ...
    //region CastCreditsContract.View
    @Override
    ...
    @Override
    public void onLoaded(@NonNull final CastCreditPresentationModel credit) {
        viewAdapter.add(HorizontalImageViewModel.newBuilder()
                .id(credit.getId())
                .imageUrl(credit.getProfileImageUrl())
                .build());
    }
    ...
    //endregion CastCreditsContract.View
}