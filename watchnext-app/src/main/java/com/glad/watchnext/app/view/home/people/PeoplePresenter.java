...
import com.glad.watchnext.app.view.home.people.PeopleContract.View;
 ...
 */
public final class PeoplePresenter implements PeopleContract.Presenter {
    @NonNull private static final String TAG = LogUtil.getTag(PeoplePresenter.class);

    private PeopleContract.View view;

    @NonNull private final GetPresentationPeopleCategoriesUseCase useCase;
    ...
    //region PeopleContract.Presenter
    @Override
    ...
    //endregion PeopleContract.Presenter
}