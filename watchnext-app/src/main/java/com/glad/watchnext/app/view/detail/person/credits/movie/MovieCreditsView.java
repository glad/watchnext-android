 ...
 */
public final class MovieCreditsView extends FrameLayout implements MovieCreditsContract.View {
    @NonNull private static final String TAG = LogUtil.getTag(MovieCreditsView.class);

    @Inject MovieCreditsContract.Presenter presenter;
    ...
    //region Constructor
    public MovieCreditsView(@NonNull final Context context) {
        this(context, null);
    }

    public MovieCreditsView(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MovieCreditsView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public MovieCreditsView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        Injector.INSTANCE.inject(this);
        inflate(context, R.layout.layout_view_movie_credits, this);
    ...
    @Override
    public void onLoaded(@NonNull final MovieCreditPresentationModel credit) {
