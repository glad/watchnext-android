 ...
 */
public final class PeopleView extends FrameLayout implements PeopleContract.View {
    @NonNull private static final String TAG = LogUtil.getTag(PeopleView.class);
    ...
    @NonNull private final CollectionPageAdapter<PeopleCollectionView> pageAdapter = new CollectionPageAdapter<>();

    //region Constructor
    public PeopleView(@NonNull final Context context) {
        this(context, null);
    }

    public PeopleView(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PeopleView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public PeopleView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        Injector.INSTANCE.inject(this);
        inflate(context, R.layout.layout_view_home_people, this);
    ...
    public void onCollectionLoaded(@NonNull final CollectionPresentationModel collection) {
        ...
        final PeopleCollectionView view = new PeopleCollectionView(getContext());
