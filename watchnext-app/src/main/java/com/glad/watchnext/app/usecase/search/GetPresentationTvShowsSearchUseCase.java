 ...
 */
public class GetPresentationTvShowsSearchUseCase implements PresentationUseCase<Observable<TvShowSimplifiedPresentationModel>, Object> {
    @NonNull private static final String TAG = LogUtil.getTag(GetPresentationTvShowsSearchUseCase.class);
    @NonNull private static final String CACHE_NAME = "tvshows-search";

    @NonNull private final GetTvShowsSearchUseCase useCase;
    ...
    public GetPresentationTvShowsSearchUseCase(
