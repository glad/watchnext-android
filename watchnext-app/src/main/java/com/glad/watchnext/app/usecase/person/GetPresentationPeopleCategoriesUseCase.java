 ...
 */
public class GetPresentationPeopleCategoriesUseCase implements PresentationUseCase<Observable<CollectionPresentationModel>, Void> {
    @NonNull private static final String TAG = LogUtil.getTag(GetPresentationPeopleCategoriesUseCase.class);
    @NonNull private static final String CACHE_NAME = "person-categories";

    @NonNull private final GetPeopleCategoriesUseCase useCase;
    ...
    public GetPresentationPeopleCategoriesUseCase(
