 ...
 */
public final class TvShowsView extends FrameLayout implements TvShowsContract.View {
    @NonNull private static final String TAG = LogUtil.getTag(TvShowsView.class);

    @Inject TvShowsContract.Presenter presenter;
    ...
    @NonNull private final CollectionPageAdapter<TvShowCollectionView> pageAdapter = new CollectionPageAdapter<>();

    //region Constructor
    public TvShowsView(@NonNull final Context context) {
        this(context, null);
    }

    public TvShowsView(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TvShowsView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public TvShowsView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        Injector.INSTANCE.inject(this);
        inflate(context, R.layout.layout_view_home_tvshows, this);
    ...
    public void onCollectionLoaded(@NonNull final CollectionPresentationModel collection) {
        ...
        final TvShowCollectionView view = new TvShowCollectionView(getContext());
    ...
    //endregion TvShowsContract.View
}