 ...
 */
public final class TvShowCollectionPresenter implements TvShowCollectionContract.Presenter {
    @NonNull private static final String TAG = LogUtil.getTag(TvShowCollectionPresenter.class);

    private TvShowCollectionContract.View view;
    private CollectionPresentationModel collection;

    @NonNull private final GetPresentationTvShowsFromCategoryUseCase useCase;
    ...
    public TvShowCollectionPresenter(
    ...
    @Override
    public void bind(@NonNull final TvShowCollectionContract.View view, @NonNull final Serializable... args) {
        this.view = view;
