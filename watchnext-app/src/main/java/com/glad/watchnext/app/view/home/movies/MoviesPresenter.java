...
import com.glad.watchnext.app.view.home.movies.MoviesContract.View;
...
public final class MoviesPresenter implements MoviesContract.Presenter {
    @NonNull private static final String TAG = LogUtil.getTag(MoviesPresenter.class);

    private MoviesContract.View view;

    @NonNull private final GetPresentationMovieCategoriesUseCase useCase;
    ...
    //region MoviesContract.Presenter
    @Override
    ...
    //endregion MoviesContract.Presenter
}