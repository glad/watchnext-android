 ...
 */
public final class PeopleCollectionView extends FrameLayout implements PeopleCollectionContract.View {
    @NonNull private static final String TAG = LogUtil.getTag(PeopleCollectionView.class);

    @Inject PeopleCollectionContract.Presenter presenter;
    ...
    //region Constructor
    public PeopleCollectionView(@NonNull final Context context) {
        this(context, null);
    }

    public PeopleCollectionView(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PeopleCollectionView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public PeopleCollectionView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
    ...
    //region PeopleCollectionContract.View
    @Override
    ...
    public void onLoaded(@NonNull final PersonSimplifiedPresentationModel person) {
        log.d(TAG, "onLoaded() called with: people = [" + person + "]");
    ...
    //endregion PeopleCollectionContract.View
}