 ...
 */
public class GetPresentationMoviesSearchUseCase implements PresentationUseCase<Observable<MovieSimplifiedPresentationModel>, Object> {
    @NonNull private static final String TAG = LogUtil.getTag(GetPresentationMoviesSearchUseCase.class);
    @NonNull private static final String CACHE_NAME = "movies-search";

    @NonNull private final GetMoviesSearchUseCase useCase;
    ...
    public GetPresentationMoviesSearchUseCase(
