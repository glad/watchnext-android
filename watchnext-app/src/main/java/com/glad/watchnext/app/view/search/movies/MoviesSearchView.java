 ...
 */
public final class MoviesSearchView extends FrameLayout implements MoviesSearchContract.View {
    @NonNull private static final String TAG = LogUtil.getTag(MoviesSearchView.class);

    @Inject MoviesSearchContract.Presenter presenter;
    ...
    //region Constructor
    public MoviesSearchView(@NonNull final Context context) {
        this(context, null);
    }

    public MoviesSearchView(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MoviesSearchView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public MoviesSearchView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
    ...
    //region MoviesSearchContract.View
    @Override
    ...
    //endregion MoviesSearchContract.View
}