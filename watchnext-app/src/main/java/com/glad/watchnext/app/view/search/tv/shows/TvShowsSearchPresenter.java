 ...
 */
public final class TvShowsSearchPresenter implements TvShowsSearchContract.Presenter {
    @NonNull private static final String TAG = LogUtil.getTag(TvShowsSearchPresenter.class);

    private TvShowsSearchContract.View view;
    @NonNull private String searchQuery = "";

    @NonNull private final GetPresentationTvShowsSearchUseCase useCase;
    ...
    @Override
    public void bind(@NonNull final TvShowsSearchContract.View view, @NonNull final Serializable... args) {
        this.view = view;
