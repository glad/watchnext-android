 ...
 */
public final class MovieCollectionPresenter implements MovieCollectionContract.Presenter {
    @NonNull private static final String TAG = LogUtil.getTag(MovieCollectionPresenter.class);

    private MovieCollectionContract.View view;
    private CollectionPresentationModel collection;

    @NonNull private final GetPresentationMoviesFromCategoryUseCase useCase;
    ...
    public MovieCollectionPresenter(
    ...
    @Override
    public void bind(@NonNull final MovieCollectionContract.View view, @NonNull final Serializable... args) {
        this.view = view;
        collection = (CollectionPresentationModel) args[0];
    }
    //region ViewPresenterContract.Presenter

    //region MovieCollectionContract.Presenter
    @Override
    ...
    //endregion MovieCollectionContract.Presenter
}