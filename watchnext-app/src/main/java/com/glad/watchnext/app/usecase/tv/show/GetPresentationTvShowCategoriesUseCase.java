 ...
 */
public class GetPresentationTvShowCategoriesUseCase implements PresentationUseCase<Observable<CollectionPresentationModel>, Void> {
    @NonNull private static final String TAG = LogUtil.getTag(GetPresentationTvShowCategoriesUseCase.class);
    @NonNull private static final String CACHE_NAME = "tvshow-categories";

    @NonNull private final GetTvShowCategoriesUseCase useCase;
    ...
    public GetPresentationTvShowCategoriesUseCase(
