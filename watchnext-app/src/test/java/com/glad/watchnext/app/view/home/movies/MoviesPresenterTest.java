...
public final class MoviesPresenterTest {

    @Mock private MoviesContract.View mockView;
    @Mock private GetPresentationMovieCategoriesUseCase mockUseCase;
    @Mock private NetworkStateProvider mockNetworkStateProvider;

    private MoviesContract.Presenter sut;
    ...
    @Before
    public void setup() {
        sut = new MoviesPresenter(mockUseCase, TestSchedulerProvider.INSTANCE, mockNetworkStateProvider, SystemLogService.INSTANCE);
        sut.bind(mockView);
