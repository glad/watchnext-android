...
public final class TvShowsPresenterTest {

    @Mock private TvShowsContract.View mockView;
    @Mock private GetPresentationTvShowCategoriesUseCase mockUseCase;
    @Mock private NetworkStateProvider mockNetworkStateProvider;

    private TvShowsContract.Presenter sut;
    ...
    @Before
    public void setup() {
        sut = new TvShowsPresenter(mockUseCase, TestSchedulerProvider.INSTANCE, mockNetworkStateProvider, SystemLogService.INSTANCE);
        sut.bind(mockView);
