...
/**
 * Use case for returning Movies from a particular category
 * <p>
 * Created by Gautam Lad
 */
public final class GetMoviesFromCategoryUseCase implements UseCase<Observable<MovieSimplified>, Object> {
    private static final String TAG = GetMoviesFromCategoryUseCase.class.getSimpleName();

    private final DataProvider dataProvider;
    private final LogService log;

    public GetMoviesFromCategoryUseCase(final DataProvider dataProvider, final LogService log) {
    ...
    public Observable<MovieSimplified> execute(final Object... args) {
        ...
        return dataProvider.fetchMoviesFromCategoryId(categoryId, pageIndex)
                .doOnError(e -> log.e(TAG, "fetchMoviesFromCategoryId(" + categoryId + ", " + pageIndex + "): " + e.getMessage(), e))
