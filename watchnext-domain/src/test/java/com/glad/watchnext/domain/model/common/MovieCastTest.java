...
public final class MovieCastTest {
    //region Dummies
    /**
    ...
    @Test (expected = InvalidMovieCreditException.class)
    public void build_WithMissingData_InvalidMovieCastExceptionThrown() throws InvalidMovieCreditException {
        MovieCredit.newBuilder()
                .build();
    }

    @Test
    public void build_WithPartialRequiredData_ModelBuiltWithDefaultValues() throws InvalidMovieCreditException {
        final MovieCredit sut = MovieCredit.newBuilder()
                .id("id")
                .title("title")
                .build();
        ...
        assertThat(sut.getCharacter(), nullValue());
    }

    @Test
    public void build_WithSuppliedData_ModelBuiltWithSuppliedValues() throws InvalidMovieCreditException {
        final MovieCredit sut = MovieCredit.newBuilder()
                .id("id")
                .title("title")
                .overview("overview")
